...
const createPrescription = async (payload: ICreatePrescriptionPayload, user: RequestUser) => {
    ...
    //? pdf creation logic start here buffer creation
    ...
    //? Loop through the medicines and add them to the PDF
    ...
    //? upload to cloudinary and send email to patient with attachment 
    ...
    //? Update the appointment with the prescription URL and public ID
    ...
    //? Send email to patient with the prescription attached
...
//* Get Single Prescription Service
